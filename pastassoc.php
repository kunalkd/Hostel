...
<div class="container">
    ...
    <div class="row">
        <div class="text-center">
            <h1>Past & Present Student Association </h1>
		...
		<div class = "col-sm-4 col-md-4">
			<div class = "thumbnail well">
				<img src = "images2/govardhandas.png" alt = "Generic placeholder thumbnail">
				
				<h3>Shri Gordhandas K. Davda</h3>
				<p>(Vice President)</p>
         
				<p class = "btn btn-default" role =" button">
				Email: gkdavda@hotmail.com
				</p>
   ...
   <div class="row">
        ...
        <div class = "col-sm-4 col-md-4">
			<div class = "thumbnail well">
				<img src = "images2/damodar.png" alt = "Generic placeholder thumbnail">
				
				<h3>Shri Damodar Ruparelia</h3>
				<p>(Hon. Secretary)</p>
				<p class = "btn btn-default" role =" button">
				Email: damodarruparelia@yahoo.in
				</p>
		...
		<div class = "col-sm-4 col-md-4">
			<div class = "thumbnail well">
				<img src = "images2/kothari.png" alt = "Generic placeholder thumbnail">
				
				<h3>Shri Vikas C.Kothari</h3>
				<p>(Hon. Secretary)</p>
				<p class = "btn btn-default" role =" button">
				Email: vikaskothari@rediffmail.com
				</p>
   ...
   <div class="row">
		...
		<div class = "col-sm-4 col-md-4">
			<div class = "thumbnail well">
				<img src = "images2/harish.png" alt = "Generic placeholder thumbnail">
				
				<h3>Shri Harish D. Chandarana</h3>
				<p>(Hon. Secretary)</p>
				<p class = "btn btn-default" role =" button">
				Email: harishchandarana@yahoo.in
				</p>
